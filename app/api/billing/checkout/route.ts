...
// Dodo Payments (Merchant of Record) checkout. Server-side session create +
// redirect — Dodo doesn't have a client-side overlay like some providers, so
// the client just POSTs here and redirects the browser to `checkout_url`.
